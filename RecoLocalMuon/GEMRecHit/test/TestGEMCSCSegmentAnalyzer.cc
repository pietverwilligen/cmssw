...
class TestGEMCSCSegmentAnalyzer : public edm::EDAnalyzer {
  ...
  TH1F *  GEMCSC_SSegm_LPx;
  TH1F *  GEMCSC_SSegm_LPy;
  TH1F *  GEMCSC_SSegm_LPEx;
  TH1F *  GEMCSC_SSegm_LPEy;
    TH1F *  GEMCSC_SSegm_LDx;
    TH1F *  GEMCSC_SSegm_LDy;
  TH1F *  GEMCSC_SSegm_LDEx;
  TH1F *  GEMCSC_SSegm_LDEy;
  TH2F *  GEMCSC_SSegm_LDEy_vs_ndof;
  TH2F *  GEMCSC_SSegm_LPEy_vs_ndof;
  TH1F *  GEMCSC_CSCSegm_LPx;
  TH1F *  GEMCSC_CSCSegm_LPy;
  TH1F *  GEMCSC_CSCSegm_LPEx;
  TH1F *  GEMCSC_CSCSegm_LPEy;
    TH1F *  GEMCSC_CSCSegm_LDx;
    TH1F *  GEMCSC_CSCSegm_LDy;
  TH1F *  GEMCSC_CSCSegm_LDEx;
  TH1F *  GEMCSC_CSCSegm_LDEy;
  TH2F *  GEMCSC_CSCSegm_LDEy_vs_ndof;
  TH2F *  GEMCSC_CSCSegm_LPEy_vs_ndof;
    
    TH1F *  SIMGEMCSC_SSegm_LDx;
    TH1F *  SIMGEMCSC_SSegm_LDy;
    TH1F *  SIMGEMCSC_SSegm_LDEx;
    TH1F *  SIMGEMCSC_SSegm_LDEy;
  ...
  TH1F * GEMCSC_Pool_geml2_y;
     ...
     TH1F * GEMCSC_Pool_gem_x_newE;
     TH1F * GEMCSC_Pool_gem_y_newE;
     TH1F * GEMCSC_Pool_gem_odd_x_newE;
     TH1F * GEMCSC_Pool_gem_odd_y_newE;
     TH1F * GEMCSC_Pool_gem_x_newE_mp;
     TH1F * GEMCSC_Pool_gem_y_newE_mp;
     TH1F * GEMCSC_Pool_gem_odd_x_newE_mp;
     TH1F * GEMCSC_Pool_gem_odd_y_newE_mp;
     TH1F * GEMCSC_Pool_gem_x_newE_mm ;
     TH1F * GEMCSC_Pool_gem_y_newE_mm ;
     TH1F * GEMCSC_Pool_gem_odd_x_newE_mm;
     TH1F * GEMCSC_Pool_gem_odd_y_newE_mm;
    
  TH1F * GEMCSC_Dphi_min_afterCut;
  TH1F * GEMCSC_Dtheta_min_afterCut;
  TH1F * GEMCSC_DR_min_afterCut;
    TH1F * GEMCSC_Dphi_min_afterCut_odd;
    TH1F * GEMCSC_Dphi_min_afterCut_even;
  TH1F * GEMCSC_Dphi_min_afterCut_l1;
  TH1F * GEMCSC_Dphi_min_afterCut_l1_odd;
  TH1F * GEMCSC_Dphi_min_afterCut_l1_even;
  TH1F * GEMCSC_Dphi_min_afterCut_l2;
  TH1F * GEMCSC_Dphi_min_afterCut_l2_odd;
  TH1F * GEMCSC_Dphi_min_afterCut_l2_even;
  TH1F * GEMCSC_Dphi_cscS_min_afterCut;
  TH1F * GEMCSC_Dtheta_cscS_min_afterCut;
    TH1F * GEMCSC_Dtheta_cscS_min_afterCut_odd;
    TH1F * GEMCSC_Dtheta_cscS_min_afterCut_even;
  TH1F * GEMCSC_DR_cscS_min_afterCut;

  TH1F * GEMCSC_Dphi_cscS_min_afterCut_l1;
  TH1F * GEMCSC_Dphi_cscS_min_afterCut_l1_odd;
  TH1F * GEMCSC_Dphi_cscS_min_afterCut_l1_even;
  TH1F * GEMCSC_Dphi_cscS_min_afterCut_l2;
  TH1F * GEMCSC_Dphi_cscS_min_afterCut_l2_odd;
  TH1F * GEMCSC_Dphi_cscS_min_afterCut_l2_even;
    
       TH1F * GEMCSC_Dphi_cscS_min_afterCut_odd;
    TH1F * GEMCSC_Dphi_cscS_min_afterCut_even;
          TH1F * GEMCSC_Dphi_cscS_min_afterCut_odd_r1;
          TH1F * GEMCSC_Dphi_cscS_min_afterCut_odd_r2;
          TH1F * GEMCSC_Dphi_cscS_min_afterCut_odd_r3;
          TH1F * GEMCSC_Dphi_cscS_min_afterCut_odd_r4;
          TH1F * GEMCSC_Dphi_cscS_min_afterCut_odd_r5;
          TH1F * GEMCSC_Dphi_cscS_min_afterCut_odd_r6;
          TH1F * GEMCSC_Dphi_cscS_min_afterCut_odd_r7;
          TH1F * GEMCSC_Dphi_cscS_min_afterCut_odd_r8;

    
  TH1F * GEMCSC_SSegm_xe_l1;
  TH1F * GEMCSC_SSegm_ye_l1;
  TH1F * GEMCSC_SSegm_ze_l1;
  TH1F * GEMCSC_SSegm_sigmaxe_l1;
  TH1F * GEMCSC_SSegm_sigmaye_l1;
  TH1F * GEMCSC_SSegm_xe_l1_odd;
  TH1F * GEMCSC_SSegm_ye_l1_odd;
  TH1F * GEMCSC_SSegm_ze_l1_odd;
  TH1F * GEMCSC_SSegm_sigmaxe_l1_odd;
  TH1F * GEMCSC_SSegm_sigmaye_l1_odd;
  TH1F * GEMCSC_SSegm_xe_l1_even;
  TH1F * GEMCSC_SSegm_ye_l1_even;
  TH1F * GEMCSC_SSegm_ze_l1_even;
  TH1F * GEMCSC_SSegm_sigmaxe_l1_even;
  TH1F * GEMCSC_SSegm_sigmaye_l1_even;
  
  TH1F * GEMCSC_SSegm_xe_l2;
  TH1F * GEMCSC_SSegm_ye_l2;
  TH1F * GEMCSC_SSegm_ze_l2;
  TH1F * GEMCSC_SSegm_sigmaxe_l2;
  TH1F * GEMCSC_SSegm_sigmaye_l2;
  TH1F * GEMCSC_SSegm_xe_l2_odd;
  TH1F * GEMCSC_SSegm_ye_l2_odd;
  TH1F * GEMCSC_SSegm_ze_l2_odd;
  TH1F * GEMCSC_SSegm_sigmaxe_l2_odd;
  TH1F * GEMCSC_SSegm_sigmaye_l2_odd;
  TH1F * GEMCSC_SSegm_xe_l2_even;
  TH1F * GEMCSC_SSegm_ye_l2_even;
  TH1F * GEMCSC_SSegm_ze_l2_even;
  TH1F * GEMCSC_SSegm_sigmaxe_l2_even;
  TH1F * GEMCSC_SSegm_sigmaye_l2_even;
    
    
  TH1F * GEMCSC_CSCSegm_xe_l1;
  TH1F * GEMCSC_CSCSegm_ye_l1;
  TH1F * GEMCSC_CSCSegm_ze_l1;
  TH1F * GEMCSC_CSCSegm_sigmaxe_l1;
  TH1F * GEMCSC_CSCSegm_sigmaye_l1;
  TH1F * GEMCSC_CSCSegm_xe_l1_odd;
  TH1F * GEMCSC_CSCSegm_ye_l1_odd;
  TH1F * GEMCSC_CSCSegm_ze_l1_odd;
  TH1F * GEMCSC_CSCSegm_sigmaxe_l1_odd;
  TH1F * GEMCSC_CSCSegm_sigmaye_l1_odd;
  TH1F * GEMCSC_CSCSegm_xe_l1_even;
  TH1F * GEMCSC_CSCSegm_ye_l1_even;
  TH1F * GEMCSC_CSCSegm_ze_l1_even;
  TH1F * GEMCSC_CSCSegm_sigmaxe_l1_even;
  TH1F * GEMCSC_CSCSegm_sigmaye_l1_even;
    
  TH1F * GEMCSC_CSCSegm_xe_l2;
  TH1F * GEMCSC_CSCSegm_ye_l2;
  TH1F * GEMCSC_CSCSegm_ze_l2;
  TH1F * GEMCSC_CSCSegm_sigmaxe_l2;
  TH1F * GEMCSC_CSCSegm_sigmaye_l2;
  TH1F * GEMCSC_CSCSegm_xe_l2_odd;
  TH1F * GEMCSC_CSCSegm_ye_l2_odd;
  TH1F * GEMCSC_CSCSegm_ze_l2_odd;
  TH1F * GEMCSC_CSCSegm_sigmaxe_l2_odd;
  TH1F * GEMCSC_CSCSegm_sigmaye_l2_odd;
  TH1F * GEMCSC_CSCSegm_xe_l2_even;
  TH1F * GEMCSC_CSCSegm_ye_l2_even;
  TH1F * GEMCSC_CSCSegm_ze_l2_even;
  TH1F * GEMCSC_CSCSegm_sigmaxe_l2_even;
  TH1F * GEMCSC_CSCSegm_sigmaye_l2_even;
    
    TH2F * SIM_etaVScharge;
    TH2F * SIM_etaVStype;
    TH2F * SIMGEMCSC_theta_cscSsh_vs_ndof_odd;
    TH2F * SIMGEMCSC_theta_cscSsh_vs_ndof_even;

    TH1F * SIMGEMCSC_Dphi_SS_min_afterCut;
    TH1F * SIMGEMCSC_Dtheta_SS_min_afterCut;
    TH1F * SIMGEMCSC_Dtheta_SS_min_afterCut_odd;
    TH1F * SIMGEMCSC_Dtheta_SS_min_afterCut_even;
    TH1F * SIMGEMCSC_Dphi_SS_min_afterCut_odd;
    TH1F * SIMGEMCSC_Dphi_SS_min_afterCut_even;
    
    TH1F * SIMGEMCSC_Dphi_cscS_min_afterCut;
    TH1F * SIMGEMCSC_Dtheta_cscS_min_afterCut;
    TH1F * SIMGEMCSC_Dtheta_cscS_min_afterCut_odd;
    TH1F * SIMGEMCSC_Dtheta_cscS_min_afterCut_even;
    TH1F * SIMGEMCSC_Dphi_cscS_min_afterCut_odd;
    TH1F * SIMGEMCSC_Dphi_cscS_min_afterCut_even;
    TH1F * SIMGEMCSC_Residuals_gem_x;
    TH1F * SIMGEMCSC_Residuals_gem_y;
    TH1F * SIMGEMCSC_Pool_gem_x_newE;
    TH1F * SIMGEMCSC_Pool_gem_y_newE;
    TH1F * SIMGEMCSC_Residuals_gem_odd_x;
    TH1F * SIMGEMCSC_Residuals_gem_odd_y;
    TH1F * SIMGEMCSC_Pool_gem_x_newE_odd;
    TH1F * SIMGEMCSC_Pool_gem_y_newE_odd;
    TH1F * SIMGEMCSC_Residuals_gem_even_x;
    TH1F * SIMGEMCSC_Residuals_gem_even_y;
    TH1F * SIMGEMCSC_Pool_gem_x_newE_even;
    TH1F * SIMGEMCSC_Pool_gem_y_newE_even;
    TH1F * SIMGEMCSC_Residuals_gem_rhsh_x;
    TH1F * SIMGEMCSC_Residuals_gem_rhsh_y;
    TH1F * SIMGEMCSC_Pool_gem_rhsh_x_newE;
    TH1F * SIMGEMCSC_Pool_gem_rhsh_y_newE;
};
//
...

{
  ...
  outputfile = new TFile(rootFileName.c_str(), "RECREATE" );
    ...
    SIM_etaVScharge = new TH2F("SimTrack_etaVScharge","SimTrack_etaVScharge",500,-2.5,2.5,6,-3,3);
    SIM_etaVStype = new TH2F("SimTrack_etaVStype","SimTrack_etaVStype",500,-2.5,2.5,30,-15,15);
  ...
  GEMCSC_SSegm_LPx    = new TH1F("SuperS_LPx","SuperS_LPx",1200,-60.,60);
  GEMCSC_SSegm_LPy    = new TH1F("SuperS_LPy","SuperS_LPy",4000,-200.,200);
  GEMCSC_SSegm_LPEx    = new TH1F("SuperS_LPEx","SuperS_LPEx",10000,0.,0.5);
  GEMCSC_SSegm_LPEy    = new TH1F("SuperS_LPEy","SuperS_LPEy",10000,0.,5);
  //GEMCSC_SSegm_LPEz    = new TH1F("SuperS_LPEz","SuperS_LPEz",1000,0.,0.5);
    GEMCSC_SSegm_LDx    = new TH1F("SuperS_LDx","SuperS_LDx",1000,-2.,2);
    GEMCSC_SSegm_LDy    = new TH1F("SuperS_LDy","SuperS_LDy",1000,-2.,2);
  GEMCSC_SSegm_LDEx    = new TH1F("SuperS_LDEx","SuperS_LDEx",10000,0.,0.05);
  GEMCSC_SSegm_LDEy    = new TH1F("SuperS_LDEy","SuperS_LDEy",10000,0.,0.5);
    GEMCSC_SSegm_LDEy_vs_ndof    = new TH2F("SSegm_LDEy_vs_ndof","SSegm_LDEy vs ndof",1000,0.,0.05,15,-0.5,14.5);
    GEMCSC_SSegm_LPEy_vs_ndof    = new TH2F("SSegm_LPEy_vs_ndof","SSegm_LPEy vs ndof",1000,0.,0.5,15,-0.5,14.5);
  //GEMCSC_SSegm_LDEz    = new TH1F("SuperS_LDEz","SuperS_LDEz",1000,0.,0.05);
  GEMCSC_CSCSegm_LPx    = new TH1F("CSCSegm_LPx","CSCSegm_LPx",1200,-60.,60);
  GEMCSC_CSCSegm_LPy    = new TH1F("CSCSegm_LPy","CSCSegm_LPy",4000,-200.,200);
  GEMCSC_CSCSegm_LPEx    = new TH1F("CSCSegm_LPEx","CSCSegm_LPEx",10000,0.,0.5);
  GEMCSC_CSCSegm_LPEy    = new TH1F("CSCSegm_LPEy","CSCSegm_LPEy",10000,0.,5);
  //GEMCSC_CSCSegm_LPEz    = new TH1F("CSCSegm_LPEz","CSCSegm_LPEz",1000,0.,0.5);
    GEMCSC_CSCSegm_LDx    = new TH1F("CSCSegm_LDx","CSCSegm_LDx",1000,-2.,2);
    GEMCSC_CSCSegm_LDy    = new TH1F("CSCSegm_LDy","CSCSegm_LDy",1000,-2.,2);
  GEMCSC_CSCSegm_LDEx    = new TH1F("CSCSegm_LDEx","CSCSegm_LDEx",10000,0.,0.05);
  GEMCSC_CSCSegm_LDEy    = new TH1F("CSCSegm_LDEy","CSCSegm_LDEy",10000,0.,0.5);
  //GEMCSC_CSCSegm_LDEz    = new TH1F("CSCSegm_LDEz","CSCSegm_LDEz",1000,0.,0.05);
      GEMCSC_CSCSegm_LDEy_vs_ndof    = new TH2F("CSCSegm_LDEy_vs_ndof","CSCSegm_LDEy vs ndof",1000,0.,0.05,15,-0.5,14.5);
    GEMCSC_CSCSegm_LPEy_vs_ndof    = new TH2F("CSCSegm_LPEy_vs_ndof","CSCSegm_LPEy vs ndof",1000,0.,0.5,15,-0.5,14.5);
    SIMGEMCSC_SSegm_LDx    = new TH1F("SSegm_LDx_expected","SSegm_LDx",1000,-2.,2);
    SIMGEMCSC_SSegm_LDy    = new TH1F("SSegm_LDy_expected","SSegm_LDy",1000,-2.,2);
    SIMGEMCSC_SSegm_LDEx    = new TH1F("SuperS_LDEx_expected","SuperS_LDEx",10000,0.,0.005);
    SIMGEMCSC_SSegm_LDEy    = new TH1F("SuperS_LDEy_expected","SuperS_LDEy",1000,0.,0.05);


  GEMCSC_SSegm_xe_l1    = new TH1F("GEMCSC_SSegm_xe_l1","GEMCSC_SSegm_xe_l1",1200,-60.,60);
  GEMCSC_SSegm_ye_l1    = new TH1F("GEMCSC_SSegm_ye_l1","GEMCSC_SSegm_ye_l1",4000,-200.,200);
  GEMCSC_SSegm_ze_l1    = new TH1F("GEMCSC_SSegm_ze_l1","GEMCSC_SSegm_ze_l1",12000,-600.,600);
  GEMCSC_SSegm_xe_l1_odd    = new TH1F("GEMCSC_SSegm_xe_l1_odd","GEMCSC_SSegm_xe_l1_odd",1200,-60.,60);
  GEMCSC_SSegm_ye_l1_odd    = new TH1F("GEMCSC_SSegm_ye_l1_odd","GEMCSC_SSegm_ye_l1_odd",4000,-200.,200);
  GEMCSC_SSegm_ze_l1_odd    = new TH1F("GEMCSC_SSegm_ze_l1_odd","GEMCSC_SSegm_ze_l1_odd",12000,-600.,600);
  GEMCSC_SSegm_xe_l1_even    = new TH1F("GEMCSC_SSegm_xe_l1_even","GEMCSC_SSegm_xe_l1_even",1200,-60.,60);
  GEMCSC_SSegm_ye_l1_even    = new TH1F("GEMCSC_SSegm_ye_l1_even","GEMCSC_SSegm_ye_l1_even",4000,-200.,200);
  GEMCSC_SSegm_ze_l1_even    = new TH1F("GEMCSC_SSegm_ze_l1_even","GEMCSC_SSegm_ze_l1_even",12000,-600.,600);
  GEMCSC_SSegm_xe_l2    = new TH1F("GEMCSC_SSegm_xe_l2","GEMCSC_SSegm_xe_l2",1200,-60.,60);
  GEMCSC_SSegm_ye_l2    = new TH1F("GEMCSC_SSegm_ye_l2","GEMCSC_SSegm_ye_l2",4000,-200.,200);
  GEMCSC_SSegm_ze_l2    = new TH1F("GEMCSC_SSegm_ze_l2","GEMCSC_SSegm_ze_l2",12000,-600.,600);
  GEMCSC_SSegm_xe_l2_odd    = new TH1F("GEMCSC_SSegm_xe_l2_odd","GEMCSC_SSegm_xe_l2_odd",1200,-60.,60);
  GEMCSC_SSegm_ye_l2_odd    = new TH1F("GEMCSC_SSegm_ye_l2_odd","GEMCSC_SSegm_ye_l2_odd",4000,-200.,200);
  GEMCSC_SSegm_ze_l2_odd    = new TH1F("GEMCSC_SSegm_ze_l2_odd","GEMCSC_SSegm_ze_l2_odd",12000,-600.,600);
  GEMCSC_SSegm_xe_l2_even    = new TH1F("GEMCSC_SSegm_xe_l2_even","GEMCSC_SSegm_xe_l2_even",1200,-60.,60);
  GEMCSC_SSegm_ye_l2_even    = new TH1F("GEMCSC_SSegm_ye_l2_even","GEMCSC_SSegm_ye_l2_even",4000,-200.,200);
  GEMCSC_SSegm_ze_l2_even    = new TH1F("GEMCSC_SSegm_ze_l2_even","GEMCSC_SSegm_ze_l2_even",12000,-600.,600);
    
  GEMCSC_CSCSegm_xe_l1    = new TH1F("GEMCSC_CSCSegm_xe_l1","GEMCSC_CSCSegm_xe_l1",1200,-60.,60);
  GEMCSC_CSCSegm_ye_l1    = new TH1F("GEMCSC_CSCSegm_ye_l1","GEMCSC_CSCSegm_ye_l1",4000,-200.,200);
  GEMCSC_CSCSegm_ze_l1    = new TH1F("GEMCSC_CSCSegm_ze_l1","GEMCSC_CSCSegm_ze_l1",12000,-600.,600);
  GEMCSC_CSCSegm_xe_l1_odd    = new TH1F("GEMCSC_CSCSegm_xe_l1_odd","GEMCSC_CSCSegm_xe_l1_odd",1200,-60.,60);
  GEMCSC_CSCSegm_ye_l1_odd    = new TH1F("GEMCSC_CSCSegm_ye_l1_odd","GEMCSC_CSCSegm_ye_l1_odd",4000,-200.,200);
    GEMCSC_CSCSegm_ze_l1_odd    = new TH1F("GEMCSC_CSCSegm_ze_l1_odd","GEMCSC_CSCSegm_ze_l1_odd",12000,-600.,600);
    GEMCSC_CSCSegm_xe_l1_even    = new TH1F("GEMCSC_CSCSegm_xe_l1_even","GEMCSC_CSCSegm_xe_l1_even",1200,-60.,60);
    GEMCSC_CSCSegm_ye_l1_even    = new TH1F("GEMCSC_CSCSegm_ye_l1_even","GEMCSC_CSCSegm_ye_l1_even",4000,-200.,200);
    GEMCSC_CSCSegm_ze_l1_even    = new TH1F("GEMCSC_CSCSegm_ze_l1_even","GEMCSC_CSCSegm_ze_l1_even",12000,-600.,600);
    GEMCSC_CSCSegm_xe_l2    = new TH1F("GEMCSC_CSCSegm_xe_l2","GEMCSC_CSCSegm_xe_l2",1200,-60.,60);
    GEMCSC_CSCSegm_ye_l2    = new TH1F("GEMCSC_CSCSegm_ye_l2","GEMCSC_CSCSegm_ye_l2",4000,-200.,200);
    GEMCSC_CSCSegm_ze_l2    = new TH1F("GEMCSC_CSCSegm_ze_l2","GEMCSC_CSCSegm_ze_l2",12000,-600.,600);
    GEMCSC_CSCSegm_xe_l2_odd    = new TH1F("GEMCSC_CSCSegm_xe_l2_odd","GEMCSC_CSCSegm_xe_l2_odd",1200,-60.,60);
    GEMCSC_CSCSegm_ye_l2_odd    = new TH1F("GEMCSC_CSCSegm_ye_l2_odd","GEMCSC_CSCSegm_ye_l2_odd",4000,-200.,200);
    GEMCSC_CSCSegm_ze_l2_odd    = new TH1F("GEMCSC_CSCSegm_ze_l2_odd","GEMCSC_CSCSegm_ze_l2_odd",12000,-600.,600);
    GEMCSC_CSCSegm_xe_l2_even    = new TH1F("GEMCSC_CSCSegm_xe_l2_even","GEMCSC_CSCSegm_xe_l2_even",1200,-60.,60);
    GEMCSC_CSCSegm_ye_l2_even    = new TH1F("GEMCSC_CSCSegm_ye_l2_even","GEMCSC_CSCSegm_ye_l2_even",4000,-200.,200);
    GEMCSC_CSCSegm_ze_l2_even    = new TH1F("GEMCSC_CSCSegm_ze_l2_even","GEMCSC_CSCSegm_ze_l2_even",12000,-600.,600);
    
    GEMCSC_SSegm_sigmaxe_l1    = new TH1F("GEMCSC_SSegm_sigmaxe_l1","GEMCSC_SSegm_sigmaxe_l1",1000,0.,0.5);
    GEMCSC_SSegm_sigmaye_l1    = new TH1F("GEMCSC_SSegm_sigmaye_l1","GEMCSC_SSegm_sigmaye_l1",1000,0.,10);
    GEMCSC_SSegm_sigmaxe_l1_odd    = new TH1F("GEMCSC_SSegm_sigmaxe_l1_odd","GEMCSC_SSegm_sigmaxe_l1_odd",1000,0.,0.5);
    GEMCSC_SSegm_sigmaye_l1_odd    = new TH1F("GEMCSC_SSegm_sigmaye_l1_odd","GEMCSC_SSegm_sigmaye_l1_odd",1000,0.,10);
    GEMCSC_SSegm_sigmaxe_l1_even    = new TH1F("GEMCSC_SSegm_sigmaxe_l1_even","GEMCSC_SSegm_sigmaxe_l1_even",1000,0.,0.5);
    GEMCSC_SSegm_sigmaye_l1_even    = new TH1F("GEMCSC_SSegm_sigmaye_l1_even","GEMCSC_SSegm_sigmaye_l1_even",1000,0.,10);
    GEMCSC_SSegm_sigmaxe_l2    = new TH1F("GEMCSC_SSegm_sigmaxe_l2","GEMCSC_SSegm_sigmaxe_l2",1000,0.,0.5);
    GEMCSC_SSegm_sigmaye_l2    = new TH1F("GEMCSC_SSegm_sigmaye_l2","GEMCSC_SSegm_sigmaye_l2",1000,0.,10);
    GEMCSC_SSegm_sigmaxe_l2_odd    = new TH1F("GEMCSC_SSegm_sigmaxe_l2_odd","GEMCSC_SSegm_sigmaxe_l2_odd",1000,0.,0.5);
    GEMCSC_SSegm_sigmaye_l2_odd    = new TH1F("GEMCSC_SSegm_sigmaye_l2_odd","GEMCSC_SSegm_sigmaye_l2_odd",1000,0.,10);
    GEMCSC_SSegm_sigmaxe_l2_even    = new TH1F("GEMCSC_SSegm_sigmaxe_l2_even","GEMCSC_SSegm_sigmaxe_l2_even",1000,0.,0.5);
    GEMCSC_SSegm_sigmaye_l2_even    = new TH1F("GEMCSC_SSegm_sigmaye_l2_even","GEMCSC_SSegm_sigmaye_l2_even",1000,0.,10);
    GEMCSC_CSCSegm_sigmaxe_l1    = new TH1F("GEMCSC_CSCSegm_sigmaxe_l1","GEMCSC_CSCSegm_sigmaxe_l1",1000,0.,0.5);
    GEMCSC_CSCSegm_sigmaye_l1    = new TH1F("GEMCSC_CSCSegm_sigmaye_l1","GEMCSC_CSCSegm_sigmaye_l1",1000,0.,10);
    GEMCSC_CSCSegm_sigmaxe_l1_odd    = new TH1F("GEMCSC_CSCSegm_sigmaxe_l1_odd","GEMCSC_CSCSegm_sigmaxe_l1_odd",1000,0.,0.5);
    GEMCSC_CSCSegm_sigmaye_l1_odd    = new TH1F("GEMCSC_CSCSegm_sigmaye_l1_odd","GEMCSC_CSCSegm_sigmaye_l1_odd",1000,0.,10);
    GEMCSC_CSCSegm_sigmaxe_l1_even    = new TH1F("GEMCSC_CSCSegm_sigmaxe_l1_even","GEMCSC_CSCSegm_sigmaxe_l1_even",1000,0.,0.5);
    GEMCSC_CSCSegm_sigmaye_l1_even    = new TH1F("GEMCSC_CSCSegm_sigmaye_l1_even","GEMCSC_CSCSegm_sigmaye_l1_even",1000,0.,10);
    GEMCSC_CSCSegm_sigmaxe_l2    = new TH1F("GEMCSC_CSCSegm_sigmaxe_l2","GEMCSC_CSCSegm_sigmaxe_l2",1000,0.,0.5);
    GEMCSC_CSCSegm_sigmaye_l2    = new TH1F("GEMCSC_CSCSegm_sigmaye_l2","GEMCSC_CSCSegm_sigmaye_l2",1000,0.,10);
    GEMCSC_CSCSegm_sigmaxe_l2_odd    = new TH1F("GEMCSC_CSCSegm_sigmaxe_l2_odd","GEMCSC_CSCSegm_sigmaxe_l2_odd",1000,0.,0.5);
    GEMCSC_CSCSegm_sigmaye_l2_odd    = new TH1F("GEMCSC_CSCSegm_sigmaye_l2_odd","GEMCSC_CSCSegm_sigmaye_l2_odd",1000,0.,10);
    GEMCSC_CSCSegm_sigmaxe_l2_even    = new TH1F("GEMCSC_CSCSegm_sigmaxe_l2_even","GEMCSC_CSCSegm_sigmaxe_l2_even",1000,0.,0.5);
    GEMCSC_CSCSegm_sigmaye_l2_even    = new TH1F("GEMCSC_CSCSegm_sigmaye_l2_even","GEMCSC_CSCSegm_sigmaye_l2_even",1000,0.,10);
  ...
  GEMCSC_Residuals_y    = new TH1F("yGEMCSCRes","yGEMCSCRes",100,-10.,10.);
  GEMCSC_Residuals_gem_y    = new TH1F("yGEMRes","yGEMRes",100,-10.,10.);
  GEMCSC_Residuals_csc_y    = new TH1F("yCSCRes","yCSCRes",100,-5.,5.);
  GEMCSC_Residuals_gem_even_y    = new TH1F("yGEMRes_even","yGEMRes even",100,-10.,10.);
  GEMCSC_Residuals_csc_even_y    = new TH1F("yCSCRes_even","yCSCRes even",100,-5.,5.);
  GEMCSC_Residuals_gem_odd_y    = new TH1F("yGEMRes_odd","yGEMRes odd",100,-10.,10.);
  ...
  GEMCSC_Pool_geml2_y = new TH1F("yGEMCSCPool_geml2","yGEMCSCPool_geml2",100,-5.,5.);
    ...
    GEMCSC_Pool_gem_x_newE    = new TH1F("xGEMPool_newE","xGEMPool_newE",100,-5.,5.);
    GEMCSC_Pool_gem_y_newE    = new TH1F("yGEMPool_newE","yGEMPool_newE",100,-5.,5.);
  GEMCSC_Pool_gem_odd_x_newE    = new TH1F("xGEMPool_odd_newE","xGEMPool odd newE",100,-5.,5.);
  GEMCSC_Pool_gem_odd_y_newE    = new TH1F("yGEMPool_odd_newE","yGEMPool odd newE",100,-5.,5.);
    GEMCSC_Pool_gem_x_newE_mp    = new TH1F("xGEMPool_newE_mp","xGEMPool_newE muon+",100,-5.,5.);
    GEMCSC_Pool_gem_y_newE_mp    = new TH1F("yGEMPool_newE_mp","yGEMPool_newE muon+",100,-5.,5.);
    GEMCSC_Pool_gem_odd_x_newE_mp    = new TH1F("xGEMPool_odd_newE_mp","xGEMPool odd newE muon+",100,-5.,5.);
    GEMCSC_Pool_gem_odd_y_newE_mp    = new TH1F("yGEMPool_odd_newE_mp","yGEMPool odd newE muon+",100,-5.,5.);
    GEMCSC_Pool_gem_x_newE_mm    = new TH1F("xGEMPool_newE_mm","xGEMPool_newE muon-",100,-5.,5.);
    GEMCSC_Pool_gem_y_newE_mm    = new TH1F("yGEMPool_newE_mm","yGEMPool_newE muon-",100,-5.,5.);
    GEMCSC_Pool_gem_odd_x_newE_mm    = new TH1F("xGEMPool_odd_newE_mm","xGEMPool odd newE muon-",100,-5.,5.);
    GEMCSC_Pool_gem_odd_y_newE_mm    = new TH1F("yGEMPool_odd_newE_mm","yGEMPool odd newE muon-",100,-5.,5.);
    
  GEMCSC_Dphi_min_afterCut = new TH1F("Dphi_gemRHgemcscS_min_afterCut","Dphi_gemRHgemcscS_min_afterCut",800000,-4.,4.);
  GEMCSC_Dtheta_min_afterCut = new TH1F("Dtheta_gemRHgemcscS_min_afterCut","Dtheta_gemRHgemcscS_min_afterCut",60000,-3.,3.);
  GEMCSC_DR_min_afterCut = new TH1F("DR_gemRHgemcscS_min_afterCut","DR_gemRHgemcscS_min_afterCut",60000,-3.,3.);
    GEMCSC_Dphi_min_afterCut_odd = new TH1F("Dphi_gemRHgemcscS_min_afterCut_odd","Dphi_gemRHgemcscS_min_afterCut_odd",800000,-4.,4.);
    GEMCSC_Dphi_min_afterCut_even = new TH1F("Dphi_gemRHgemcscS_min_afterCut_even","Dphi_gemRHgemcscS_min_afterCut_even",800000,-4.,4.);
    GEMCSC_Dphi_min_afterCut_l1 = new TH1F("Dphi_gemRHgemcscS_min_afterCut_l1","Dphi_gemRHgemcscS_min_afterCut_l1",800000,-4.,4.);
    GEMCSC_Dphi_min_afterCut_l1_odd = new TH1F("Dphi_gemRHgemcscS_min_afterCut_l1_odd","Dphi_gemRHgemcscS_min_afterCut_l1_odd",800000,-4.,4.);
    GEMCSC_Dphi_min_afterCut_l1_even = new TH1F("Dphi_gemRHgemcscS_min_afterCut_l1_even","Dphi_gemRHgemcscS_min_afterCut_l1_even",800000,-4.,4.);
    GEMCSC_Dphi_min_afterCut_l2 = new TH1F("Dphi_gemRHgemcscS_min_afterCut_l2","Dphi_gemRHgemcscS_min_afterCut_l2",800000,-4.,4.);
    GEMCSC_Dphi_min_afterCut_l2_odd = new TH1F("Dphi_gemRHgemcscS_min_afterCut_l2_odd","Dphi_gemRHgemcscS_min_afterCut_l2_odd",800000,-4.,4.);
    GEMCSC_Dphi_min_afterCut_l2_even = new TH1F("Dphi_gemRHgemcscS_min_afterCut_l2_even","Dphi_gemRHgemcscS_min_afterCut_l2_even",800000,-4.,4.);
    
    GEMCSC_Dphi_cscS_min_afterCut = new TH1F("Dphi_gemRHcscS_min_afterCut","Dphi_gemRHcscS_min_afterCut",800000,-4.,4.);
    GEMCSC_Dtheta_cscS_min_afterCut = new TH1F("Dtheta_gemRHcscS_min_afterCut","Dtheta_gemRHcscS_min_afterCut",60000,-3.,3.);
    GEMCSC_DR_cscS_min_afterCut = new TH1F("DR_gemRHcscS_min_afterCut","DR_gemRHcscS_min_afterCut",60000,-3.,3.);
    GEMCSC_Dphi_cscS_min_afterCut_l1 = new TH1F("Dphi_gemRHcscS_min_afterCut_l1","Dphi_gemRHcscS_min_afterCut_l1",800000,-4.,4.);
    GEMCSC_Dphi_cscS_min_afterCut_l1_odd = new TH1F("Dphi_gemRHcscS_min_afterCut_l1_odd","Dphi_gemRHcscS_min_afterCut_l1_odd",800000,-4.,4.);
    GEMCSC_Dphi_cscS_min_afterCut_l1_even = new TH1F("Dphi_gemRHcscS_min_afterCut_l1_even","Dphi_gemRHcscS_min_afterCut_l1_even",800000,-4.,4.);
    GEMCSC_Dphi_cscS_min_afterCut_l2 = new TH1F("Dphi_gemRHcscS_min_afterCut_l2","Dphi_gemRHcscS_min_afterCut_l2",800000,-4.,4.);
    GEMCSC_Dphi_cscS_min_afterCut_l2_odd = new TH1F("Dphi_gemRHcscS_min_afterCut_l2_odd","Dphi_gemRHcscS_min_afterCut_l2_odd",800000,-4.,4.);
    GEMCSC_Dphi_cscS_min_afterCut_l2_even = new TH1F("Dphi_gemRHcscS_min_afterCut_l2_even","Dphi_gemRHcscS_min_afterCut_l2_even",800000,-4.,4.);
    
    GEMCSC_Dphi_cscS_min_afterCut_odd = new TH1F("Dphi_gemRHcscS_min_afterCut_odd","Dphi_gemRHcscS_min_afterCut_odd",800000,-4.,4.);
    GEMCSC_Dphi_cscS_min_afterCut_even = new TH1F("Dphi_gemRHcscS_min_afterCut_even","Dphi_gemRHcscS_min_afterCut_even",800000,-4.,4.);
    GEMCSC_Dphi_cscS_min_afterCut_odd_r1 = new TH1F("Dphi_gemRHcscS_min_afterCut_odd_r1","Dphi_gemRHcscS_min_afterCut_odd_r1",800000,-4.,4.);
    GEMCSC_Dphi_cscS_min_afterCut_odd_r2 = new TH1F("Dphi_gemRHcscS_min_afterCut_odd_r2","Dphi_gemRHcscS_min_afterCut_odd_r2",800000,-4.,4.);
    GEMCSC_Dphi_cscS_min_afterCut_odd_r3 = new TH1F("Dphi_gemRHcscS_min_afterCut_odd_r3","Dphi_gemRHcscS_min_afterCut_odd_r3",800000,-4.,4.);
    GEMCSC_Dphi_cscS_min_afterCut_odd_r4 = new TH1F("Dphi_gemRHcscS_min_afterCut_odd_r4","Dphi_gemRHcscS_min_afterCut_odd_r4",800000,-4.,4.);
    GEMCSC_Dphi_cscS_min_afterCut_odd_r5 = new TH1F("Dphi_gemRHcscS_min_afterCut_odd_r5","Dphi_gemRHcscS_min_afterCut_odd_r5",800000,-4.,4.);
    GEMCSC_Dphi_cscS_min_afterCut_odd_r6 = new TH1F("Dphi_gemRHcscS_min_afterCut_odd_r6","Dphi_gemRHcscS_min_afterCut_odd_r6",800000,-4.,4.);
    GEMCSC_Dphi_cscS_min_afterCut_odd_r7 = new TH1F("Dphi_gemRHcscS_min_afterCut_odd_r7","Dphi_gemRHcscS_min_afterCut_odd_r7",800000,-4.,4.);
    GEMCSC_Dphi_cscS_min_afterCut_odd_r8 = new TH1F("Dphi_gemRHcscS_min_afterCut_odd_r8","Dphi_gemRHcscS_min_afterCut_odd_r8",800000,-4.,4.);
    GEMCSC_Dtheta_cscS_min_afterCut_odd = new TH1F("Dtheta_gemRHcscS_min_afterCut_odd","Dtheta_gemRHcscS_min_afterCut_odd",60000,-3.,3.);
    GEMCSC_Dtheta_cscS_min_afterCut_even = new TH1F("Dtheta_gemRHcscS_min_afterCut_even","Dtheta_gemRHcscS_min_afterCut_even",60000,-3.,3.);
    
    
    SIMGEMCSC_Dphi_cscS_min_afterCut = new TH1F("Dphi_gemSHcscS_min_afterCut","Dphi_gemSHcscS_min_afterCut",800000,-4.,4.);
    SIMGEMCSC_Dtheta_cscS_min_afterCut = new TH1F("Dtheta_gemSHcscS_min_afterCut","Dtheta_gemSHcscS_min_afterCut",60000,-3.,3.);
    SIMGEMCSC_Dphi_cscS_min_afterCut_odd = new TH1F("Dphi_gemSHcscS_min_afterCut_odd","Dphi_gemSHcscS_min_afterCut_odd",800000,-4.,4.);
    SIMGEMCSC_Dphi_cscS_min_afterCut_even = new TH1F("Dphi_gemSHcscS_min_afterCut_even","Dphi_gemSHcscS_min_afterCut_even",800000,-4.,4.);
    SIMGEMCSC_Dtheta_cscS_min_afterCut_odd = new TH1F("Dtheta_gemSHcscS_min_afterCut_odd","Dtheta_gemSHcscS_min_afterCut_odd",60000,-3.,3.);
    SIMGEMCSC_Dtheta_cscS_min_afterCut_even = new TH1F("Dtheta_gemSHcscS_min_afterCut_even","Dtheta_gemSHcscS_min_afterCut_even",60000,-3.,3.);
    
    SIMGEMCSC_Dphi_SS_min_afterCut = new TH1F("Dphi_gemSHSS_min_afterCut","Dphi_gemSHSS_min_afterCut",800000,-4.,4.);
    SIMGEMCSC_Dtheta_SS_min_afterCut = new TH1F("Dtheta_gemSHSS_min_afterCut","Dtheta_gemSHSS_min_afterCut",60000,-3.,3.);
    SIMGEMCSC_Dphi_SS_min_afterCut_odd = new TH1F("Dphi_gemSHSS_min_afterCut_odd","Dphi_gemSHSS_min_afterCut_odd",800000,-4.,4.);
    SIMGEMCSC_Dphi_SS_min_afterCut_even = new TH1F("Dphi_gemSHSS_min_afterCut_even","Dphi_gemSHSS_min_afterCut_even",800000,-4.,4.);
    SIMGEMCSC_Dtheta_SS_min_afterCut_odd = new TH1F("Dtheta_gemSHSS_min_afterCut_odd","Dtheta_gemSHSS_min_afterCut_odd",60000,-3.,3.);
    SIMGEMCSC_Dtheta_SS_min_afterCut_even = new TH1F("Dtheta_gemSHSS_min_afterCut_even","Dtheta_gemSHSS_min_afterCut_even",60000,-3.,3.);
    
    SIMGEMCSC_theta_cscSsh_vs_ndof_odd    = new TH2F("SIMGEMCSCSegm_theta_cscSsh_vs_ndof_odd","theta_cscSsh vs ndof odd",30000,0.,3.,15,-0.5,14.5);
    SIMGEMCSC_theta_cscSsh_vs_ndof_even    = new TH2F("SIMGEMCSCSegm_theta_cscSsh_vs_ndof_even","theta_cscSsh vs ndof even",30000,0.,3.,15,-0.5,14.5);
    
    SIMGEMCSC_Residuals_gem_x    = new TH1F("xGEMRes_simhit","xGEMRes",100,-0.5,0.5);
    SIMGEMCSC_Residuals_gem_y    = new TH1F("yGEMRes_simhit","yGEMRes",100,-10.,10.);
    SIMGEMCSC_Pool_gem_x_newE    = new TH1F("xGEMPool_newE_simhit","xGEMPool newE",100,-10.,10.);
    SIMGEMCSC_Pool_gem_y_newE    = new TH1F("yGEMPool_newE_simhit","yGEMPool newE",100,-10.,10.);
    SIMGEMCSC_Residuals_gem_odd_x    = new TH1F("xGEMRes_odd_simhit","xGEMRes",100,-0.5,0.5);
    SIMGEMCSC_Residuals_gem_odd_y    = new TH1F("yGEMRes_odd_simhit","yGEMRes",100,-10.,10.);
    SIMGEMCSC_Pool_gem_x_newE_odd    = new TH1F("xGEMPool_odd_newE_simhit","xGEMPool newE",100,-10.,10.);
    SIMGEMCSC_Pool_gem_y_newE_odd    = new TH1F("yGEMPool_odd_newE_simhit","yGEMPool newE",100,-10.,10.);
    SIMGEMCSC_Residuals_gem_even_x    = new TH1F("xGEMRes_even_simhit","xGEMRes",100,-0.5,0.5);
    SIMGEMCSC_Residuals_gem_even_y    = new TH1F("yGEMRes_even_simhit","yGEMRes",100,-10.,10.);
    SIMGEMCSC_Pool_gem_x_newE_even    = new TH1F("xGEMPool_even_newE_simhit","xGEMPool newE",100,-10.,10.);
    SIMGEMCSC_Pool_gem_y_newE_even    = new TH1F("yGEMPool_even_newE_simhit","yGEMPool newE",100,-10.,10.);
    
    SIMGEMCSC_Residuals_gem_rhsh_x= new TH1F("xGEMRes_shrh","xGEMRes",100,-0.5,0.5);
    SIMGEMCSC_Residuals_gem_rhsh_y= new TH1F("yGEMRes_shrh","yGEMRes",100,-10.,10.);
    SIMGEMCSC_Pool_gem_rhsh_x_newE= new TH1F("xGEMPool_shrh","xGEMPool sh rh",100,-5.,5.);
    SIMGEMCSC_Pool_gem_rhsh_y_newE= new TH1F("yGEMPool_shrh","yGEMPool sh rh",100,-5.,5.);
...
edm::PSimHitContainer SimHitMatched(std::vector<GEMRecHit>::const_iterator recHit, edm::ESHandle<GEMGeometry> gemGeom, const Event & event)
{
