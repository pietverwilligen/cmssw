#ifndef ME0Segment_ME0CondSegFit_h
#define ME0Segment_ME0CondSegFit_h

// ME0CondSegFit.h -- segment fit factored out of CSCSegAlgoST - Tim Cox
// Last mod: 29.01.2015
 ...
 * Used now also for the ME0 segment building
 */
...
class ME0CondSegFit : public MuonSegFit {

public:

 ME0CondSegFit( const edm::ParameterSet& ps, const MuonRecHitContainer& hits) : 
  MuonSegFit( hits ),
    worstHit_( 0 ),
 ...
 private:  
  ...
  void correctTheCovMatrix(MuonSegFit::SMatrixSym2& IC);
