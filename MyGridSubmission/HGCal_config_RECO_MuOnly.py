...
process.source = cms.Source("PoolSource",
    ...
    fileNames=cms.untracked.vstring(
      # 'file:/lustre/cms/store/user/piet/ME0Segment_Time/DYToMuMu_M-20_TuneZ2star_14TeV-pythia6-tauola_HGCALGS_GEN-SIM_v2/DYToMuMu_M-20_TuneZ2star_14TeV-pythia6-tauola_HGCALGS_PU140_100ps_500um_1cm_v2_DIGI/151113_124202/0001/JME-TP2023SHCALDR-00001_step1_1030.root'
      # 'file:/lustre/cms/store/user/piet/ME0Segment_Time/DYToMuMu_M-20_TuneZ2star_14TeV-pythia6-tauola_HGCALGS_GEN-SIM_v2/DYToMuMu_M-20_TuneZ2star_14TeV-pythia6-tauola_HGCALGS_PU140_5ns_500um_1cm_v2_DIGI/151113_124638/0000/JME-TP2023SHCALDR-00001_step1_1.root'
      'file:/lustre/cms/store/user/piet/ME0Segment_Time/SampleProd4/DYToMuMu_M-20_TuneZ2star_14TeV-pythia6-tauola_HGCALGS_GEN-SIM_v2/DYToMuMu_M-20_TuneZ2star_14TeV-pythia6-tauola_HGCALGS_PU0_1ns_500um_1cm_SP4_v1_DIGI/151210_173510/0000/JME-TP2023SHCALDR-00001_step1_1.root',
...
process.me0Segments.algo_pset.dPhiChainBoxMax = cms.double(.020)     # default: 0.020
process.me0Segments.algo_pset.dEtaChainBoxMax = cms.double(.050)     # default: 0.050
process.me0Segments.algo_pset.dTimeChainBoxMax = cms.double(250.0)   # default: 1.5ns (100ps) --- 7ns (1ns)
process.load('RecoLocalMuon.GEMRecHit.me0RecHits_cfi')
process.me0RecHits.recAlgoConfig.recOnlyMuons = cms.bool(True)       # default: False
process.me0RecHits.recAlgoConfig.recOnlyPrompt = cms.bool(True)      # default: False
